...
<template>
    <DialogPortal>
        <DialogOverlay
            class="bg-black/80 fixed inset-0 z-50 grid place-items-center overflow-y-auto data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:animate-in data-[state=open]:fade-in-0"
        >
            <DialogContent
                :class="
                    cn(
