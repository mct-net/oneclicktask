...
import FileAttachment from '@/components/common/FileAttachment.vue';
import IconClip from '@/components/icons/IconClip.vue';
import IconHighlighter from '@/components/icons/IconHighlighter.vue';
...
import TextEditorAction from '@/components/common/TextEditorAction.vue';
import {
    addFileAttachment,
    useDropZone,
    useFileDialog,
...
const editor = useEditor({
    ...
    onUpdate: () => {
        if (!editor.value || !taskStore.selectedTask) return;
        taskStore.selectedTask.content = editor.value.getHTML();
        debouncedUpdateTask();
    },
